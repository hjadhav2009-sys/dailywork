...
try {
  ...
  if (!summary.ok) {
    console.error("Cannot start DailyWork Pick & Pack:");
  ...
  console.log("");
  console.log("Starting DailyWork Pick & Pack local production server...");
  ...
  console.error(error instanceof Error ? error.message : "Failed to start DailyWork Pick & Pack.");
  process.exit(1);
}
